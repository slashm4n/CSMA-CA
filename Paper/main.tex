...
The first step was to create a simulation of the classic CSMA/CA protocol\cite{classic_CSMA_CA}.
\nl
...
\FloatBarrier
\section{Performance}
In this section we are going to analyze how the performance of a single protocol varies by changing the parameters\cite{stats}. Three metrics were considered:
...
\begin{thebibliography}{9}
	\bibitem{classic_CSMA_CA}
	https://github.com/slashm4n/CSMA-CA/blob/main/CSMA-CA\_v11\%20(Classic).py
	\bibitem{adaptive_CSMA_CA}
	https://github.com/slashm4n/CSMA-CA/blob/main/CSMA-CA\_v14\%20(Adaptive).py
	\bibitem{stats}
	https://github.com/slashm4n/CSMA-CA/blob/main/plot\_statistics.py
	\end{thebibliography}
\end{document}