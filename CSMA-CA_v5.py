...
p_packet = 0.03 # the probability of sending a packet
...
class RTSpacket:
    def __init__(self, parent_node, lenght_data):
        ...
        self.length_data = lenght_data + 3 # + 3 because it's SIFS + CTS + SIFS
...
class CSMAGui:
    def __init__(self, root, channel, node_activities, receiver, step_ms=200):
        ...
        self.colors = {0: "white", 1: "light grey", 2: "red", 3: "green", 4: "light blue", 5: "light green", 6: "dark olive green", 7: "yellow"}
    ...
    def animate_step(self):
        ...
        colors = {0: "white", 1: "green", 2: "yellow", 3: "light blue", 4: "light green"}
