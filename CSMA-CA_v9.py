...
class TransmitterNode:
    def __init__(self, p_packet=0.3, packet_length=5, name="0"):
        ...
        self.data_to_send = 0
        self.contention_window_up = 5
        self.contention_window_low = 3
    ...
    def try_send_data(self, channel, t, node_activity):
        ...
        # If there's a collision
                ...
                self.DIFS = 0
                if node_activity[t-2] == 5: # if I was in backoff, increasethe contention window
                    self.contention_window_up += 2
                    #self.contention_window_low += 2
                self.exponential_backoff = rn.randint(self.contention_window_low,self.contention_window_up)
        ...
        # If the channel is idle and I want to send data
                ...
                node_activity[t] = 3
                try:
                    if type(channel_status[t-1]) == ACKpacket:
                        self.contention_window_up = 5
                except:
                    pass
