...
class CSMAGui:
    def __init__(self, root, channel, node_activities, receiver, step_ms=200):
        ...
        self.colors = {0: "white", 1: "light grey", 2: "red", 3: "green", 4: "light blue", 5: "light green", 6: "dark olive green", 7: "yellow", 8: "dark turquoise"}
    ...
    def animate_step(self):
        ...
        colors = {0: "white", 1: "dark olive green", 2: "dark turquoise"}
